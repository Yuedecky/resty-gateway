...
-- commit 9c187e17952d2d1b03d84db082c64be88bbaedb2
--
...
--
-- @param [ t y p e = n u m b e r ] seed (Optional) A seed to use. If none given, will
...
do
    if ngx and string.find(ngx.config.nginx_configure(), '--with-pcre-jit', nil, true) then
        ...
        --
        -- @param [ t y p e = s t r i n g ] str String to verify.
...
do
    if ngx then
        ...
        -- @param [ t y p e = s t r i n g ] namespace (must be a valid UUID according to `is_valid`)
        ...
        --
        -- @param [ t y p e = s t r i n g ] namespace (must be a valid UUID according to `is_valid`)
        -- @param [ t y p e = s t r i n g ] name
